...
const appCss = "/assets/styles-Dpzq4F5P.css";
...
const Route$h = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Cycle Companion Care tracks menstrual cycles, aids pregnancy journeys, and connects users with gynecologists."
      },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "strotas" },
      {
      ...
      { name: "twitter:title", content: "strotas" },
      {
      ...
      {
        property: "og:image",
        content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4aa59cf3-5e10-4006-9560-33567652ea1e/id-preview-a6677bd7--b4b79ce2-6e02-4e8f-ae23-3812dba9be8c.lovable.app-1776450458361.png"
      },
      {
        name: "twitter:image",
        content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4aa59cf3-5e10-4006-9560-33567652ea1e/id-preview-a6677bd7--b4b79ce2-6e02-4e8f-ae23-3812dba9be8c.lovable.app-1776450458361.png"
...
const $$splitComponentImporter$g = () => import("./pregnancy-C1UHY7Di.js");
const Route$g = createFileRoute("/pregnancy")({
  head: () => ({
    meta: [{
      title: "Pregnancy Companion — Blume"
    }, {
      name: "description",
      content: "Weekly development, symptoms, birth plan, and trimester nutrition."
    }, {
      property: "og:title",
      content: "Pregnancy Companion — Blume"
    }, {
      property: "og:description",
      content: "Your weekly guide through pregnancy."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./cycle-DysywQ9Z.js");
const Route$f = createFileRoute("/cycle")({
  head: () => ({
    meta: [{
      title: "Cycle Intelligence — Blume"
    }, {
      name: "description",
      content: "Phase-aware calendar, daily briefings, mood logging, and AI weekly planning."
    }, {
      property: "og:title",
      content: "Cycle Intelligence — Blume"
    }, {
      property: "og:description",
      content: "Track, predict, and optimize your life around your cycle."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./care-BkRoWYvD.js");
const Route$e = createFileRoute("/care")({
  head: () => ({
    meta: [{
      title: "Care Connection — Find your gynecologist · Blume"
    }, {
      name: "description",
      content: "Find specialists by symptom, city, or sub-speciality. Save favourites, see ratings, and book."
    }, {
      property: "og:title",
      content: "Care Connection — Blume"
    }, {
      property: "og:description",
      content: "Find the right women's-health specialist near you."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./index-EvgLMWvI.js");
const Route$d = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "Blume — Cycle, Pregnancy & Care Companion"
    }, {
      name: "description",
      content: "Track your cycle, navigate pregnancy, and find the right care — all in one warm, intelligent companion."
    }, {
      property: "og:title",
      content: "Blume — Your women's health companion"
    }, {
      property: "og:description",
      content: "Cycle intelligence, pregnancy companion, and care connection in one app."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./pregnancy.wellness-B_JJk7Um.js");
const Route$c = createFileRoute("/pregnancy/wellness")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./pregnancy.trackers-BHvQT8nT.js");
const Route$b = createFileRoute("/pregnancy/trackers")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./pregnancy.support-DP0kdyzL.js");
const Route$a = createFileRoute("/pregnancy/support")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./pregnancy.planning-0SbHogix.js");
const Route$9 = createFileRoute("/pregnancy/planning")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./pregnancy.journey-CuNbd-bv.js");
const Route$8 = createFileRoute("/pregnancy/journey")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./cycle.trackers-BuKd4tQM.js");
const Route$7 = createFileRoute("/cycle/trackers")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./cycle.plan-Bi4lEJmo.js");
const Route$6 = createFileRoute("/cycle/plan")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./cycle.overview-C_oUMOAo.js");
const Route$5 = createFileRoute("/cycle/overview")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./cycle.manage-BsXDbvlk.js");
const Route$4 = createFileRoute("/cycle/manage")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./cycle.health-B8xtdX8f.js");
const Route$3 = createFileRoute("/cycle/health")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./care.questions-CeBMpwv7.js");
const Route$2 = createFileRoute("/care/questions")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./care.favourites-DTFsjeFV.js");
const Route$1 = createFileRoute("/care/favourites")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitNotFoundComponentImporter = () => import("./care._id-Cvvj3PBh.js");
const $$splitComponentImporter = () => import("./care._id-DwaLaHMl.js");
const Route2 = createFileRoute("/care/$id")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  notFoundComponent: lazyRouteComponent($$splitNotFoundComponentImporter, "notFoundComponent")
});
const PregnancyRoute = Route$g.update({
  id: "/pregnancy",
  path: "/pregnancy",
  getParentRoute: () => Route$h
});
const CycleRoute = Route$f.update({
  id: "/cycle",
  path: "/cycle",
  getParentRoute: () => Route$h
});
const CareRoute = Route$e.update({
  id: "/care",
  path: "/care",
  getParentRoute: () => Route$h
});
...
const PregnancyWellnessRoute = Route$c.update({
  id: "/wellness",
  path: "/wellness",
  getParentRoute: () => PregnancyRoute
});
const PregnancyTrackersRoute = Route$b.update({
  id: "/trackers",
  path: "/trackers",
  getParentRoute: () => PregnancyRoute
});
const PregnancySupportRoute = Route$a.update({
  id: "/support",
  path: "/support",
  getParentRoute: () => PregnancyRoute
});
const PregnancyPlanningRoute = Route$9.update({
  id: "/planning",
  path: "/planning",
  getParentRoute: () => PregnancyRoute
});
const PregnancyJourneyRoute = Route$8.update({
  id: "/journey",
  path: "/journey",
  getParentRoute: () => PregnancyRoute
});
const CycleTrackersRoute = Route$7.update({
  id: "/trackers",
  path: "/trackers",
  getParentRoute: () => CycleRoute
});
const CyclePlanRoute = Route$6.update({
  id: "/plan",
  path: "/plan",
  getParentRoute: () => CycleRoute
});
const CycleOverviewRoute = Route$5.update({
  id: "/overview",
  path: "/overview",
  getParentRoute: () => CycleRoute
});
const CycleManageRoute = Route$4.update({
  id: "/manage",
  path: "/manage",
  getParentRoute: () => CycleRoute
});
const CycleHealthRoute = Route$3.update({
  id: "/health",
  path: "/health",
  getParentRoute: () => CycleRoute
});
const CareQuestionsRoute = Route$2.update({
  id: "/questions",
  path: "/questions",
  getParentRoute: () => CareRoute
});
const CareFavouritesRoute = Route$1.update({
  id: "/favourites",
  path: "/favourites",
  getParentRoute: () => CareRoute
});
const CareIdRoute = Route2.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => CareRoute
});
const CareRouteChildren = {
  CareIdRoute,
  CareFavouritesRoute,
  CareQuestionsRoute
};
const CareRouteWithChildren = CareRoute._addFileChildren(CareRouteChildren);
const CycleRouteChildren = {
  CycleHealthRoute,
  CycleManageRoute,
  CycleOverviewRoute,
  CyclePlanRoute,
...
const PregnancyRouteChildren = {
  PregnancyJourneyRoute,
  PregnancyPlanningRoute,
  PregnancySupportRoute,
  PregnancyTrackersRoute,
  PregnancyWellnessRoute
};
const PregnancyRouteWithChildren = PregnancyRoute._addFileChildren(
  PregnancyRouteChildren
);
const rootRouteChildren = {
  IndexRoute,
  CareRoute: CareRouteWithChildren,
  CycleRoute: CycleRouteWithChildren,
  PregnancyRoute: PregnancyRouteWithChildren
};
